...
// The Lattice harness route: the docs' background scene with its tuning drivers.
...
export default function LatticeFixture() {
  ...
  return (
    <Page viewportOverlays>
      <PageHeader title="Lattice scene checks" description="The docs' background on the engine's own surface: park and resume the clock, step the energy, switch the scheme, jump to each assembly moment, and sample the frame trace, the inline style writes per second and the live CSS animations." />
