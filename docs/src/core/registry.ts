...
import e_atoms_input_example_10 from "./examples/atoms/input/example-10";
import e_atoms_input_example_11 from "./examples/atoms/input/example-11";
import e_atoms_input_example_12 from "./examples/atoms/input/example-12";
import e_atoms_input_example_13 from "./examples/atoms/input/example-13";
import e_atoms_input_example_14 from "./examples/atoms/input/example-14";
import e_atoms_input_example_15 from "./examples/atoms/input/example-15";
import e_atoms_input_example_16 from "./examples/atoms/input/example-16";
...
import e_atoms_select_example_8 from "./examples/atoms/select/example-8";
...
import e_molecules_field_example_5 from "./examples/molecules/field/example-5";
import e_molecules_field_example_6 from "./examples/molecules/field/example-6";
import e_molecules_field_example_7 from "./examples/molecules/field/example-7";
import e_molecules_field_example_8 from "./examples/molecules/field/example-8";
import e_molecules_field_example_9 from "./examples/molecules/field/example-9";
import e_molecules_field_example_10 from "./examples/molecules/field/example-10";
import e_molecules_field_example_11 from "./examples/molecules/field/example-11";
...
import e_molecules_form_example_5 from "./examples/molecules/form/example-5";
import e_molecules_form_example_6 from "./examples/molecules/form/example-6";
import e_molecules_form_example_7 from "./examples/molecules/form/example-7";
import e_molecules_form_example_8 from "./examples/molecules/form/example-8";
import e_molecules_form_example_9 from "./examples/molecules/form/example-9";
...
import e_organisms_data_table_example_15 from "./examples/organisms/data-table/example-15";
...
export const COMPONENT_DOCS: Record<string, DocEntry> = {
  ...
  "input": {
    ...
    examples: [
      ...
      { label: "Email", code: "<Input label=\"Email address\" leadingIcon icon=\"mail\" placeholder=\"example@domain.com\" keyboardType=\"email-address\" autoCapitalize=\"none\" autoComplete=\"email\" />", render: e_atoms_input_example_6 },
      { label: "Password", code: "<Input label=\"Password\" leadingIcon icon=\"lock\" secureTextEntry passwordToggle placeholder=\"••••••••\" autoComplete=\"password\" />", render: e_atoms_input_example_7 },
      { label: "Username", code: "<Input label=\"Username\" leadingIcon icon=\"user\" placeholder=\"yourname\" defaultValue=\"danello87\" autoCapitalize=\"none\" autoComplete=\"username\" />", render: e_atoms_input_example_8 },
      { label: "Date of birth", code: "<Input label=\"Date of birth\" leadingIcon icon=\"calendar\" placeholder=\"MM/DD/YYYY\" keyboardType=\"numbers-and-punctuation\" autoComplete=\"birthdate-full\" />", render: e_atoms_input_example_9 },
      { label: "Currency", code: "<Input label=\"Amount\" prefix=\"$\" placeholder=\"0.00\" keyboardType=\"decimal-pad\" />", render: e_atoms_input_example_10 },
  ...
  "data-table": {
    ...
    examples: [
      ...
      { label: "Attached", code: "<Card flat flush style={{ overflow: \"hidden\" }}>\n  <DataTable\n    attached\n    columns={[\"Name\", \"Email\", \"Role\"]}\n    rows={[\n      [\"Alice Johnson\", \"alice@example.com\", \"Admin\"],\n      [\"Bob Smith\", \"bob@example.com\", \"Editor\"],\n      [\"Rachel Chen\", \"rachel@example.com\", \"Admin\"]\n    ]}\n  />\n</Card>", render: e_organisms_data_table_example_2 },
