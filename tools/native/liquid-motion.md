...
is the layer's own layout size for the whole travel and its rim bands scale with the
pane. `test/popup-motion.test.tsx` reads the displayed box back off the transform,
