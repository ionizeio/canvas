...
export const inventory = [
  "view", "text", "pressable", "image", "text-input", "scroll-view", "row-column", "grid", "container", "chip", "emblem", "sparkline", "autocomplete", "avatar", "badge", "breadcrumb", "button-group", "button", "checkbox", "divider", "dropdown", "icon", "input", "pagination", "radio", "reveal", "select", "skeleton", "textarea", "swatch", "switch", "tooltip", "alert", "alert-dialog", "listbox", "card", "code-block", "field", "empty-state", "form", "filter-panel", "board", "calendar", "command", "dashboard-grid", "data-table", "dialog", "drag-drop", "drawer", "sidebar", "steps", "tab-bar", "tabs", "kbd", "typography", "spinner", "progress", "slider", "accordion", "action-sheet", "backdrop", "stepper", "input-otp", "collapsible", "carousel", "toast", "popover", "qrcode", "row-menu", "action-panels", "description-lists", "feeds", "grid-lists", "media-objects", "phone-input", "stacked-lists", "stats", "chart", "line-chart", "area-chart", "pie-chart", "scatter-plot", "candlestick-chart", "depth-chart", "stacked-bar", "gauge", "heatmap", "bar-list", "metric-breakdown", "uptime-bar", "service-health-list", "bullet-chart", "progress-ring", "composed-chart", "range-area-chart", "histogram", "box-plot", "waterfall-chart", "radial-bar-chart", "funnel-chart", "radar-chart", "treemap", "geo-map", "navbars",
];
...
export const evidence: InteractionEvidence[] = [
  ...
  { id: "phone-input-country-pick", components: ["phone-input"], layer: "unit-web", file: "test/phone-input.test.tsx", test: "picking a country from the segment's list swaps the dial code and reports the code" },
  { id: "input-password-toggle", components: ["input"], layer: "unit-web", file: "test/input-actions.test.tsx", test: "the eye reveals a masked password and re-masks it" },
  { id: "input-clear", components: ["input"], layer: "unit-web", file: "test/input-actions.test.tsx", test: "the clear button empties the field and reports an empty value" },
];
