...
and required verification recipes. Roles are internal tooling metadata, not public
string-valued styling props:
...
The initial inventory covered 99 product families, 104 component docs entries and
142 public renderable APIs; the Backdrop and its four compound members left it on
2026-09-22. These are descriptive counts, not hard-coded limits: future public APIs
must be classified.
