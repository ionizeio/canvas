...
const config: LookoutConfig = {
  ...
  neverFile: [
    ...
    "the brand type family (Manrope) everywhere, in Dark Factory's dense scale (bold titles, 12.5 medium body): only size, weight, and line-height must map to platform roles",
