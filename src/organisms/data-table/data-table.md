...
On narrow web and Android layouts, the columns still share the table width and
wrap their text, each keeping a 110 px minimum (a column with a fixed `width`
