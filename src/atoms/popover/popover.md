...
menu takes its button: the button's pill and label vanish as a droplet forms on
the pill's frame, the card blooms out of it (or up from it when it fits above)
with a bounded contour overshoot, recoils and settles, and on close its content
